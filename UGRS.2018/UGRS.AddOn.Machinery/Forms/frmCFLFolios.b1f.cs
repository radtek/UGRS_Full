...
{
    [FormAttribute("UGRS.AddOn.Machinery.Forms.frmCFLFolios", "Forms/frmCFLFolios.b1f")]
    class frmCFLFolios : UserFormBase
    {
        ...
        #region Constructor
        public frmCFLFolios(FoliosFormModeEnum pEnmFoliosModeEnum = FoliosFormModeEnum.RelatedRise)
        {
            LoadEvents();
            LoadFolios(pEnmFoliosModeEnum);
        }
        #endregion
        ...
        public override void OnInitializeComponent()
        {
            ...
            this.btnSelection = ((SAPbouiCOM.Button)(this.GetItem("btnSel").Specific));
        ...
        private SAPbouiCOM.Button btnSelection;
