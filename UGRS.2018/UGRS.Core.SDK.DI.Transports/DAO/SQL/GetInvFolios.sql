...
select Top 10 U_Ticket as U_GLO_Ticket, U_InternalFolio as DocNum, '' as Status, 'FI' as Type from [dbo].[@UG_TR_INTLFRGHT] where U_Shared = 2 order by U_InternalFolio desc ) last
