select T0.DocEntry, T1.SlpCode,T2.SlpName, T4.ItemName,T1.LineTotal,T1.LineTotal * (T5.U_Commission/100) as U_Commission,
...
ISNULL((select U_Value from [@UG_CONFIG] where Name = 'TR_LIQ_IMPORTE'), 0) as WkDisc
