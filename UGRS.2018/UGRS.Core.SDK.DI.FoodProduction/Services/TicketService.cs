...
namespace UGRS.Core.SDK.DI.FoodProduction.Services
{
    ...
    {
        private TableDAO<Ticket> mObjTicketDAOTable;
        private TicketDAO mObjTicketDAO;

        public TicketService()
        {
            mObjTicketDAOTable = new TableDAO<Ticket>();
            mObjTicketDAO = new TicketDAO();
        }

        public int Add(Ticket pObjTicket)
        {
            return mObjTicketDAOTable.Add(pObjTicket);
        }

        public int Update(Ticket pObjTicket)
        {
            return mObjTicketDAOTable.Update(pObjTicket);
        }
        ...
        public string GetUserTransfer(string pStrDocNum)
        {
            return mObjTicketDAO.GetUserTransfer(pStrDocNum);
        }
    }
}
