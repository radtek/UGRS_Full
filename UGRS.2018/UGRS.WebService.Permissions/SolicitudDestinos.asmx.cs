...
using UGRS.Core.SDK.DI.WebServicePermissions;
    ...
    public class SolicitudDestinos : System.Web.Services.WebService
    {
            ...
            int id_producto)
        {
            ...
            try
            {
                ...
                mObjPermissionServices.GetTime("editar Destinos", mDblTime);
                if (lIntResultCode == 0)
                {
        ...
        public string Borrar(int id)
        {
            try
            {
                ...
                mObjPermissionServices.GetTime("borrar Destinos", mDblTime);
                if (lIntResultCode == 0)
                {
                    return "borrado";
                }
