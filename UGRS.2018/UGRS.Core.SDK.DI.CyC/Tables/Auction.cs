...
namespace UGRS.Core.SDK.DI.CyC.Tables
{
    ...
    public class Auction : Table
    {
        ...
        [Field(Description = "AutCorral", Size = 1)]
        public bool AutCorral { get; set; }

        [Field(Description = "AutTransp", Size = 1)]
        public bool AutTransp { get; set; }

        [Field(Description = "AutAuction", Size = 1)]
        public bool AutAuction { get; set; }

        [Field(Description = "AutCyC", Size = 1)]
        public bool AutCyC { get; set; }

        [Field(Description = "AutFz", Size = 1)]
