...
namespace UGRS.Core.SDK.DI.WebServicePermissions.UserFields
{
    [SAPObject("ORDR")]
    public class SaleOrder : SAPObject
    {
        ...
        [Field(Description = "Entrada2", Size = 50)]
        public string PE_Entrada2 { get; set; }

        [Field(Description = "Salida2", Size = 50)]
        public string PE_Salida2 { get; set; }
