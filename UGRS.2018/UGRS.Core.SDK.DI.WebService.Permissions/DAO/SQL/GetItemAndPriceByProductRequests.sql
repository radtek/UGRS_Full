SELECT T2.U_ItemCode, T2.U_InsureCU, T2.U_InsureTrans, T1.U_Quantity , T3.Price, T1.U_Description
...
WHERE T4.U_GLO_Location = 'PEHE' AND T1.U_RequestId = '{RequestId}' AND T2.U_IdPEPETY ='{MobilizationTypeId}'
