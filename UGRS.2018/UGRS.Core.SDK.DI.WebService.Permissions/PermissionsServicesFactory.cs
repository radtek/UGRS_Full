...
namespace UGRS.Core.SDK.DI.WebServicePermissions
{
    ...
    public class PermissionsServicesFactory
    {
        ...
        */
        ...
        public DateTime UnixTimeStampToDateTime(string pStrDate)
        {
            ...
            dtDateTime = DateTime.Now;//dtDateTime.AddSeconds(Convert.ToDouble(pStrDate)).ToLocalTime();
            return dtDateTime;
        }
        ...
        public void GetTime(string lStrmesage, DateTime pDblTime)
        {
            TimeSpan lTmsTime = DateTime.Now - pDblTime;
